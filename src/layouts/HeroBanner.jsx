              ...
              <div className="customer-container relative z-20 flex h-full flex-col items-center justify-between gap-6 pb-8 pt-12 sm:pb-8 sm:pt-16 md:pb-10 md:pt-20 lg:flex-row lg:py-0">
                <div className="flex flex-1 flex-col items-center space-y-4 pt-4 text-center text-white md:space-y-6 lg:items-start lg:space-y-8 lg:pl-4 lg:pt-0 lg:text-left">
                  <div className="flex flex-col items-center gap-2 md:gap-4 lg:items-start lg:gap-6">
                    ...
                    <h2 className="max-w-[681px] font-sans text-3xl font-bold leading-[40px] tracking-normal sm:text-5xl sm:leading-[58px] lg:max-w-[800px] lg:text-[48px] lg:leading-[58px] xl:text-[54px] xl:leading-[64px] 2xl:text-[65px] 2xl:leading-[75px]">
                      {item.title} <br />
                      <span className="text-[#CE9F2D]">{item.highlight}</span>
                    </h2>
                  </div>

                  <p className="max-w-[681px] font-sans text-xs font-normal leading-relaxed text-white/80 sm:text-sm md:text-base lg:text-[18px] lg:leading-[28px]">
                    {item.description}
                  </p>
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-3 pt-1 md:pt-3 lg:justify-start">
                    <SolidLargeButton
                      to={item.primaryLink}
                      className="h-[40px] min-w-[116px] rounded-[8px] px-4 text-xs font-bold shadow-none hover:scale-105 sm:h-[44px] sm:min-w-[128px] sm:px-5 sm:text-sm lg:h-[48px] lg:w-[141px] lg:min-w-0 lg:rounded-[10px] lg:px-[22px]"
                    >
                      {item.primaryButton}
                    </SolidLargeButton>
                    ...
                    <OutlineLightButton
                      ...
                      className="h-[42px] min-w-[156px] rounded-[8px] px-4 text-xs font-bold hover:scale-105 sm:h-[46px] sm:min-w-[184px] sm:px-5 sm:text-sm lg:h-[50px] lg:w-[212px] lg:min-w-0 lg:rounded-[10px]"
                    >
