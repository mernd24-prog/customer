  ...
  return (
    <div className={cn("grid gap-1.5 font-montserrat", className)}>
      ...
      <select
        ...
        className={cn(
          "min-h-11 w-full cursor-pointer appearance-none rounded-[8px] border border-[#cfc6b8] bg-white px-3 py-2.5 font-montserrat text-sm text-[#2E2E2E] outline-none transition-all duration-300 ease-in-out",
