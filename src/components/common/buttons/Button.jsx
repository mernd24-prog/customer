...
const variantMap = {
  primary: "border border-[var(--customer-gold)] bg-[var(--customer-gold)] text-[var(--customer-navy)] shadow-sm hover:bg-[var(--customer-gold-dark)] hover:border-[var(--customer-gold-dark)] hover:shadow-md",
  secondary: "border border-[var(--customer-border)] bg-white text-[var(--customer-navy)] hover:border-[var(--customer-gold)] hover:bg-[var(--customer-gold-soft)]",
  ...
  gradient: "border border-transparent bg-gradient-to-r from-[var(--customer-gold-dark)] to-[var(--customer-gold)] text-[var(--customer-navy)] shadow-sm hover:shadow-md",
  outline: "bg-white border border-[var(--customer-navy)] text-[var(--customer-navy)] hover:bg-[var(--customer-navy-soft)]",
  ghost: "bg-transparent text-[var(--customer-navy)] hover:bg-[var(--customer-navy-soft)] border border-transparent",
