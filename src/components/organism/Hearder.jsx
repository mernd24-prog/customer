...
export const TopHeader = () => {
  ...
  return (
    <div className="hidden h-[39px] w-full items-center border-b border-[#2d3080] bg-[#1B1D60] text-[12px] text-white lg:flex">
            ...
            <div className="flex h-[44px] w-full items-center overflow-hidden rounded-full border-none bg-white pl-3 pr-1 outline-none sm:h-[48px] sm:pl-4 lg:h-[54px] lg:pl-6 lg:pr-1.5">
              ...
              <div className="ml-1 flex shrink-0 items-center gap-2 sm:gap-3 lg:ml-2 lg:gap-6">
                ...
                <Button
                  variant="custom"
                  rounded={true}
                  className="flex h-[32px] w-[78px] items-center justify-center gap-1 text-[10px] font-bold sm:h-[36px] sm:w-[90px] sm:gap-2 lg:h-[42px] lg:w-[120px] lg:text-sm"
                  bgColor={gradientBg}
                  textColor="#FFFFFF"
