...
export default function HomeProductsForYouSection({ loading = false }) {
  ...
  return (
    <section className="my-8 rounded-[10px]  bg-[#F7F6F500] p-5 sm:p-4 lg:p-6">
      <h2 className="text-center font-montserrat text-[16px] font-semibold text-[#2E2E2E] sm:text-[18px]">
        Products For You
      </h2>
      <div className="mt-4 grid grid-cols-2 gap-4 sm:gap-4  md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
        {loading
          ? list.map((_, index) => (
