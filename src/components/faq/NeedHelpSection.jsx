...
export default function NeedHelpSection({
  ...
  return (
    <section
      ...
      } items-center bg-[linear-gradient(270deg,_#A26D27_5.77%,_#CE9F2D_100%)] px-4 py-8 sm:px-6 md:px-12`}
    >
      <div className={`${layout === "row" ? "text-left max-w-[800px]" : "text-center max-w-[660px]"}`}>
        ...
        <p className="mt-2 font-montserrat text-[12px] font-normal leading-5 text-white/90 sm:text-[13px]">
          {description}
        </p>
      </div>
