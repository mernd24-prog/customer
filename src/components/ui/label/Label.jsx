...
const variants = {
  seasonSale:
    "border border-[#CE9F2D4D] bg-[#CE9F2D1A] text-[#8A6500] font-bold uppercase tracking-[0.6px]",

  outline: "border border-[#E8B84B] bg-white text-[#8A6500] font-semibold",
  ...
  imageLabel:
    "min-h-[31px] min-w-[77px] justify-center rounded-[25px] border border-[#CE9F2D] bg-[#1F2430] bg-[linear-gradient(#CE9F2D,#CE9F2D)] px-[15px] py-[5px] text-white font-bold shadow-md",
};
