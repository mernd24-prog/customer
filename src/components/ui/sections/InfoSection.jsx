...
const InfoSection = () => {
  const { title, description1, description2, image, logo, brandText } =
    infoSectionData;
        ...
        <div className="flex flex-col items-start text-left w-full lg:w-[60%] px-4 sm:px-10 lg:px-0 lg:py-10">
          <div className="flex flex-col gap-6 w-full ">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="max-w-2xl font-montserrat text-sm leading-relaxed text-white/80 lg:text-base">
                {description2}
              </p>
            </div>
          </div>
          ...
          <div className="relative mt-10 flex flex-col bg-white rounded-2xl shadow-2xl px-6 py-5 lg:px-10 lg:py-6 w-full max-w-md lg:max-w-[550px] lg:block hidden">
            ...
            <div className="flex items-center mb-3 pl-4 ">
              ...
              <div className="flex-1 h-[2px] bg-gray-100 ml-2"></div>
            </div>
            {/* Bottom Text - All in one line to maintain width look */}
            <div className="pl-4">
              <h3 className="font-montserrat text-xl lg:text-3xl font-bold tracking-tight whitespace-nowrap">
