...
import { Mail, Phone, MapPin, Clock3, Send, CheckCircle, X } from "lucide-react";
...
export default function ContactUs() {
  ...
  return (
    <section className="bg-[#faf8f3] py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#1d2377]">
