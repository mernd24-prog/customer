...
const ORDER_LIST_SKELETON = [
  {
    ...
    children: [
      {
        type: "col",
        className: "rounded-xl border border-[#EFE5D2] bg-white overflow-hidden",
        children: [
          { type: "row", className: "w-full border-b border-[#EFE5D2] bg-[#FFF8E7] p-4 justify-between", children: [
            { type: "box", width: "40%", height: "20px", className: "rounded-md" },
            { type: "box", width: "20%", height: "20px", className: "rounded-md" },
          ]},
          { 
            type: "grid", 
            className: "grid-cols-[100px_minmax(0,1fr)] sm:grid-cols-[150px_minmax(0,1fr)] gap-4 p-4 md:p-5", 
            children: [
              { type: "box", height: "140px", className: "rounded-xl" },
              { type: "col", className: "gap-2 w-full", children: [
                { type: "box", height: "24px", width: "80%", className: "rounded-md" },
                { type: "box", height: "16px", width: "30%", className: "rounded-md mb-2" },
                { type: "box", height: "28px", width: "80px", className: "rounded-full mb-2" },
                { type: "box", height: "32px", width: "120px", className: "rounded-[10px] mt-auto" },
              ] }
            ]
          }
        ]
...
const ORDER_DETAIL_SKELETON = [
  {
    type: "grid",
    className: "grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8",
    children: [
      { type: "col", className: "p-4 bg-white border border-[#EFE5D2] rounded-[12px] gap-2", children: [
         { type: "box", width: "60%", height: "16px", className: "rounded-md" },
         { type: "box", width: "80%", height: "24px", className: "rounded-md" }
      ]},
      { type: "col", className: "p-4 bg-white border border-[#EFE5D2] rounded-[12px] gap-2", children: [
         { type: "box", width: "60%", height: "16px", className: "rounded-md" },
         { type: "box", width: "80%", height: "24px", className: "rounded-md" }
  ...
  { type: "box", height: "140px", className: "rounded-[12px] mb-8 w-full border border-[#EFE5D2]" },
  {
    type: "grid",
    className: "grid-cols-1 xl:grid-cols-[minmax(0,1fr)_380px] gap-6",
    children: [
      { type: "col", className: "bg-white border border-[#EFE5D2] p-5 rounded-[12px] gap-4", children: [
        { type: "row", className: "w-full bg-[#FFF8E7] p-4 rounded-[8px]", children: [
           { type: "box", width: "100px", height: "100px", className: "rounded-lg" },
           { type: "col", className: "flex-1 ml-4 gap-2", children: [
              { type: "box", width: "80%", height: "20px", className: "rounded-md" },
              { type: "box", width: "40%", height: "16px", className: "rounded-md" },
           ]}
        ]}
      ]},
      { 
        type: "col", 
        className: "w-full rounded-[12px] border border-[#EFE5D2] p-5 lg:p-7 bg-white gap-4",
        children: [
    ...
    <>
      ...
      <div className="mx-auto w-full max-w-[1740px]">
        <ApiState
          ...
          error={state.error}
          empty={!order}
          skeletonLayout={ORDER_DETAIL_SKELETON}
      ...
      <div className="flex  flex-col gap-3 border-b border-[#E7D9B8] bg-[#CE9F2D33] px-3 py-4 md:flex-row md:items-center  md:justify-between md:gap-4 md:px-4 md:py-6  text-sm md:text-base 2xl:text-[20px]  font-semibold text-ink">
        <div className="flex w-full flex-col items-start gap-2 sm:flex-row sm:items-center sm:justify-between md:contents">
          <span className="flex min-w-0 items-center gap-1.5">
            ...
            <span className="min-w-0 break-all small" title={apiOrderId}>{displayOrderId(apiOrderId)}</span>
            <button
              type="button"
    ...
    <article className="overflow-hidden rounded-xl border border-[#E7D9B8] bg-[#FFFCF6]">
      <div className="flex flex-col gap-2 border-b border-[#E7D9B8] bg-[#CE9F2D33] px-3 py-3 text-sm font-semibold text-ink md:flex-row md:items-center md:justify-between md:px-4">
        <span className="flex min-w-0 items-center gap-1.5">
          ...
          <span className="min-w-0 break-all text-xs md:text-sm" title={apiOrderId}>
            #{displayOrderId(apiOrderId)}
          </span>
          <button
            type="button"
            onClick={handleCopyOrderId}
