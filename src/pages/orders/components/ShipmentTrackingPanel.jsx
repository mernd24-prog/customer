          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3 bg-[#FFF9EA] px-4 py-4 sm:px-6">
              <div className="flex items-center  gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#CE9F2D] text-white">
                  <Package size={20} />
                </span>
                <div>
              ...
              <span className="rounded-full bg-[#1B1D60] px-3 py-1 text-xs font-semibold text-white">
                {label(displayStatus)}
              </span>
            </div>
                ...
                <div className="mt-3 space-y-3">
                  {(events.length
                    ...
                    <div
                      ...
                      className="relative border-l-2 border-[#CE9F2D66] pl-4 last:border-transparent"
                    >
