      ...
      >
        <form className="grid gap-5" onSubmit={handleSubmit(submit)} noValidate>
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="font-montserrat text-sm font-semibold text-[#CE9F2D] underline-offset-4 transition hover:text-[#A26D27] hover:underline"
              onClick={() => {
          ...
          <p className="text-center font-montserrat text-[0.8rem] text-[#9E886A]">
            <Link to={AUTH_ROUTES.login} className="font-semibold text-[#CE9F2D] underline-offset-4 transition hover:text-[#A26D27] hover:underline">
              Back to login
            </Link>
          </p>
          <p className="text-center font-montserrat text-[0.8rem] text-[#9E886A]">
